...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Carrera</h3>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        @can('crear-carrera')
                        <a class="btn btn-warning" href="{{ route('carreras.create') }}">Crear nueva</a>
                        @endcan
                        &nbsp;
                        ...
                        <table class="table table-striped mt-2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('carreras.destroy',$carrera->id) }}" class="formulario-eliminar" method="POST">
                                            <a class="btn btn-sm btn-primary " href="{{ route('carreras.show',$carrera->id) }}"><i class="fa fa-fw fa-eye"></i> Mostrar</a>
                                            @can('editar-carrera')
    ...
    <script>
        Swal.fire(
            'Eliminado!',
            'La carrera se elimino correctamente.',
            'success'
        )
    </script>
    @endif
    ...
    <script>
        $('.formulario-eliminar').submit(function(e) {
            e.preventDefault();
            Swal.fire({
                title: 'Usted se encuentra a punto de borrar una carrera',
