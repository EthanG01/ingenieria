        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Más información de proyecto</h2>
        ...
        <section id="testimonials" class="testimonials">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                      @foreach ($lista as $Can)  
                            <div class="testimonial-item">
                                <img src="/fotoOrganizaciones/{{ $Can->involucrado->cantonorganizacion->organizacion->fotoOrganizacion }}"
                                    class="testimonial-img" alt="">
                                <h3>{{ $Can->proyecto->nombreProyecto }}</h3>
                                <h4>{{ $Can->proyecto->categoria->nombreCategoria }}</h4>
                              

                                <div class="entry-meta">
                                    <ul>
                                        <li class="d-flex align-items-center"><i class="bi bi-pin"></i>
                                            <a>{{ $Can->involucrado->cantonorganizacion->canton->provincia->nombreProvincia }}</a><a>,<a>&nbsp
                                                    <a>{{ $Can->involucrado->cantonorganizacion->canton->nombreCanton }}</a>
                                        </li>
                                    </ul>
                                </div>
                              

                                <a class="product-short-description"> <i class="bi bi-person"></i> {{$Can->involucrado->persona->nombrePersona}} {{$Can->involucrado->persona->apellido1}} {{$Can->involucrado->persona->apellido2}}</a>
                                ...
                                <h6>{{ $Can->proyecto->fechaInicial }}</h6>
                            </div>
                            @endforeach
                    </div>
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="footer-info">
                                ...
                                <div class="social-links mt-3">
                                    <a href="https://twitter.com/CemedeUna?s=20&t=03tQ0cHRwWTHpsUReMxIvQ"
