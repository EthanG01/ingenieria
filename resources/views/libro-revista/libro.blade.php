                    ...
                    <div class="col-lg-15 entries">
                        ...
                        <article class="entry">
                            ...
                            <div class="entry-meta">
                                <ul>
                                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a>{{$galery->autor->nombreAutor}}</a>&nbsp;<a>{{$galery->autor->apellidoAutor1}}</a></li>
                                    <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a>{{$galery->editorial->nombreEditorial}}</a></li>
                                    <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a>{{$galery->cant_pag}}</a></li>
                                </ul>
                            </div>
                            
                            <div class="entry-content">
                            <a href="/libros/{{$galery->documentoLR}}"> Visualizar Documento </a>
                                </div>
